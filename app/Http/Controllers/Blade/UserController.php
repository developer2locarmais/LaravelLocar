...
class UserController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        {
            message_set("Você não tem permissão de edição de administrador",'error',5);
    ...
    public function update(Request $request, $id)
    {
        ...
        $activity .="\nAntes das atualizações: ".logObj($user);
        $activity .=' Funções antes: "'.implode(',',$user->getRoleNames()->toArray()).'"';
